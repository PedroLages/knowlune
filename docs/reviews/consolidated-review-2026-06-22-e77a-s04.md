...
- unknown: Boundary condition at exactly 30 days is not tested; staleness check uses strict greater-than (>), so 30 days exactly is NOT stale (src/app/components/settings/**tests**/DataAndBackupPanel.meta.test.tsx:115) [Consensus: 75]
...
- unknown: DataAndBackupPanel.meta.test.tsx uses an inline createSettings helper with colorScheme 'professional' while actual defaults are now 'clean' (src/app/components/settings/**tests**/DataAndBackupPanel.meta.test.tsx:55) [Consensus: 80]
