...
--
-- Timestamp note: filename 20260413 reflects the plan / design date; story was authored
-- 2026-04-17. The earlier timestamp is intentional — it orders before follow-up migrations
-- (e.g. 20260417000002_p0_sync_foundation_fixups.sql which addresses review findings).
