// E119-S11: Deno-compatible retention policy re-export
//
// This file is a Deno-compatible mirror of `src/lib/compliance/retentionPolicy.ts`.
// It exists because the browser module imports from `consentService.ts` (a React/browser
// module) which cannot be resolved in the Deno Edge Function runtime.
//
// IMPORTANT: This file MUST be kept in sync with `src/lib/compliance/retentionPolicy.ts`.
// When adding, removing, or modifying entries in the browser module, update this file too.
// The parity test in `src/lib/compliance/__tests__/retentionParity.test.ts` checks the
// browser module for self-consistency; add a matching check there if you want CI enforcement
// of Deno-copy parity.
//
// Consumed by: supabase/functions/retention-tick/index.ts
...
export interface RetentionEntry {
   ...
   * `null` entries require explicit reviewer sign-off.
   */
  period: string | null
 ...
 *
 * KEEP IN SYNC with src/lib/compliance/retentionPolicy.ts
 */
