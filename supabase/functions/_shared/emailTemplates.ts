...
// same functions for unit testing in the Node/Vitest context.
//
 ...
 * a cancel link (valid for 7 days, matching SOFT_DELETE_GRACE_DAYS).
 *
 * @param cancelUrl - URL the user can visit to cancel. Currently the app settings
 *   page; a one-time-token link is a future enhancement.
 */
 ...
 * pending_deletions table), since auth.users may no longer be accessible.
 */
