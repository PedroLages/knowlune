...
export function QuizScoreTracker({
  ...
  return (
    <div
      ...
      className={`sticky top-2 right-2 z-10 ml-auto w-fit bg-card border border-border rounded-xl shadow-sm px-3 py-1.5 flex items-center gap-2 text-sm font-medium transition-transform duration-100 ${
