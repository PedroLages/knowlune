  ...
  return (
    <Card
      ...
      className={cn(
        ...
        'motion-safe:hover:shadow-md motion-safe:hover:-translate-y-px transition-all duration-200',
    ...
    >
      <article
        role="listitem"
        aria-label={`${ctaLabel} for ${topicName} - Score ${score}, ${trend}`}
