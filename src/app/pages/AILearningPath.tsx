    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      {hasPath && !isGenerating && (
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
          <SortableContext items={courses.map(c => c.courseId)} strategy={verticalListSortingStrategy}>
            <motion.div
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              Any manual reordering will be replaced, and manual overrides will be lost.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
