...
This document describes the modular documentation pattern used by Knowlune's story workflow skills (start-story, review-story, finish-story) to improve maintainability, reduce duplication, and enable focused updates.
