...
This skill is an **orchestrator** — it coordinates work but does not perform deep analysis itself. Read `.Codex/skills/_shared/orchestrator-principles.md` for the full pattern.
...
1. Load design principles from .Codex/workflows/design-review/design-principles.md
...
3. **If user selects gaps**, generate E2E test files:
   ...
   - Follow conventions from `.Codex/rules/testing/test-patterns.md`
...
**Generated by**: Codex (app-audit skill)
```
