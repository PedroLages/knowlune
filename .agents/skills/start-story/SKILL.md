...
8b. **Design guidance suggestion** (idempotent): Follow the algorithm in `.Codex/skills/start-story/docs/design-guidance.md`. Summary:
...
- **Route map & stack patterns**: `.Codex/skills/start-story/docs/reference-tables.md`
- **Common mistakes & recovery**: `.Codex/skills/start-story/docs/recovery-and-gotchas.md`
- **Worktree setup details**: `.Codex/skills/start-story/docs/worktree-setup.md`
- **Status validation scenarios**: `.Codex/skills/start-story/docs/status-validation.md`
- **Design guidance algorithm**: `.Codex/skills/start-story/docs/design-guidance.md`
