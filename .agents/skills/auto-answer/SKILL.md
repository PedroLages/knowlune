...
/auto-answer              # Codex asks which mode to use
```
...
- `AGENTS.md` and `.Codex/rules/` — Project conventions
- `src/` — Actual codebase for technical questions
- Memory files in `/Users/pedro/.Codex/projects/-Volumes-SSD-Dev-Apps-Knowlune/memory/`
