...
2. **Loads Standards**: Reads `.Codex/workflows/design-review/design-principles.md`
...
- **Agent definition**: `.Codex/agents/design-review.md` — full methodology and MCP tool usage
- **Design standards**: `.Codex/workflows/design-review/design-principles.md` — project-tailored tokens and rules
- **Agent config**: `.Codex/workflows/design-review/agent-config.md` — architecture documentation
