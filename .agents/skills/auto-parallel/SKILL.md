...
**Implementation Plan:**
- Full 12-week roadmap: `.Codex/plans/eager-floating-haven.md`
- Week 1-2 foundation: `src/ai/orchestration/README.md`

**Related Skills:**
- `.Codex/skills/dispatching-parallel-agents/SKILL.md` - Manual parallel dispatch
- `.Codex/skills/start-story/SKILL.md` - Story workflow
- `.Codex/skills/brainstorming/SKILL.md` - Creative task planning
