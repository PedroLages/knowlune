        ...
        const books = [
          {
            ...
            author: 'Jane Author',
            description: 'A complete EPUB book with all metadata fields populated for comprehensive testing of the About Book dialog display capabilities.',
            format: 'epub',
...
async function runTests() {
  ...
  const context = await browser.newContext({
    ...
    recordVideo: { dir: '/tmp/test-videos', size: { width: 1280, height: 720 } }
  });
